...
│   ├── Consulta SQL + resultado.png
│   └── Estrutura do projeto.png
│
├── powerbi/
...
![Dashboard](Dashboard_Olist_Ecommerce.png)

---

## Consulta SQL + Resultado

![SQL](Consulta_SQL_resultado.png)

---

## Estrutura do Projeto

![Estrutura](Estrutura_do_projeto.png)
